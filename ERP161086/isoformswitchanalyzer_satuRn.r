...
outdir <- "/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/ERP161086/diu"
dir.create(outdir, showWarnings = FALSE, recursive = TRUE)
setwd(outdir)

### Import quantifications
salmonQuant <- importIsoformExpression(
    parentDir = "/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/ERP161086/salmon/"
)
...
metadata <- read.table("/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/ERP161086/metadata.txt", header=TRUE, sep="\t")
