...
switch_rds <- file.path(diu_dir, "switchList_with_gene_name.rds")
helper_script <- file.path(base_dir, "scripts", "custom_switch_plot_helpers.R")
outdir <- file.path(diu_dir, "custom_plots", "all_significant_ORF_annotated")
