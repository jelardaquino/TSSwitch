...
gtf_file <- "/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/syn52065646_LongRead/jaquino_analysis/NanoporeRNASeq_extended_annotations.gtf"   # your GTF
tx_counts_file <- "/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/syn52065646_LongRead/jaquino_analysis/bambu_tx_tpm.txt"
DTU_sig_file <- "/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/syn52065646_LongRead/jaquino_analysis/diu/IsoformSwitchAnalyzeR_top_switches_gene_name.tsv"
DTU_61_genes <- read.table(DTU_sig_file, header = TRUE, sep = "\t")

output_dir_tables <- "/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/syn52065646_LongRead/jaquino_analysis_v2/tables/promoter_usage_86_genes_12samples/"
output_dir_figures <- "/home/AD.UNLV.EDU/Shared_Data/AlternativeSplicing/syn52065646_LongRead/jaquino_analysis_v2/figures/promoter_usage_86_genes_12samples/"
...
sig_tx <- unique(tx_gene_map[gene_id %in% as.character(DTU_61_genes$gene_id), transcript_id])
...
write.table(promoter_counts_dt, paste0(output_dir_tables, "promoter_counts_9samples.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(usage_long, paste0(output_dir_tables, "promoter_usage_long_9samples.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(res_usage, paste0(output_dir_tables, "promoter_usage_betareg_results_9samples.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)
...
write.table(switching_genes_usage, paste0(output_dir_tables, "switching_promoter_usage_9samples.tsv"), sep = "\t", row.names = FALSE, quote = FALSE)
...
ggsave(paste0(output_dir_figures, "promoter_usage_switching_genes_all.png"), width = 15, height = 12, dpi=300)
...
genes_to_label <- c("NOTCH4", "SNCA", "NSD2")
